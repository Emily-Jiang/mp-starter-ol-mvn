...
This will create an executable jar file **demomaven.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/demomaven.jar
